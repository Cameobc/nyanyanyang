...
<!-- Footer -->
  ...
  <script src="<%=application.getContextPath() %>/js/jqBootstrapValidation.js"></script>
  <script src="<%=application.getContextPath() %>/js/contact_me.js"></script>

  <!-- Custom scripts for this template -->
  <script src="<%=application.getContextPath() %>/js/agency.min.js"></script>
